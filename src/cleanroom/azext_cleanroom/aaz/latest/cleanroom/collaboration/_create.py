...
@register_command(
    "cleanroom collaboration create",
)
class Create(AAZCommand):
    """Create a collaboration.

    :example: Create Collaboration
        az cleanroom collaboration create --resource-group testrg --collaboration-name ContosoCollaboration --location northeurope --consortium-type ConfidentialACI --user-identity "{tenant-id:fd3c3665-1729-4b7b-9a38-238e83b0f98b,object-id:fd3c3665-1729-4b7b-9a38-238e83b0f98b,account-type:microsoft}"
    """

    _aaz_info = {
        "version": "2025-10-31-preview",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/private.cleanroom/collaborations/{}", "2025-10-31-preview"],
        ]
    }
    ...
    class CollaborationsCreate(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Private.CleanRoom/collaborations/{collaborationName}",
                **self.url_parameters
            )
