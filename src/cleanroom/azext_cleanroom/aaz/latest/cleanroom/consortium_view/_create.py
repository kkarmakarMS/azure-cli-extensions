...
@register_command(
    "cleanroom consortium-view create",
)
class Create(AAZCommand):
    """Create a consortium view.

    :example: Create Consortium View
        az cleanroom consortium-view create --resource-group testrg --consortium-view-name ContosoConsortiumView --location northeurope --consortium-endpoint https://ContosoEndpoint/ --consortium-service-certificate-pem Contoso certificate pem --member "{certificate-pem:membercertificate,signed-payload:membersignedpayload}"
    """
