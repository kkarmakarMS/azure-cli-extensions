...
class List(AAZCommand):
    ...
    :example: List consortium views in subscription
        az cleanroom consortium-view list
    """
    ...
    class ConsortiumViewsListBySubscription(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/subscriptions/{subscriptionId}/providers/" + PrivateEndpointUtil.get_configured_namespace() + "/consortiumViews",
                **self.url_parameters
            )
    ...
    class ConsortiumViewsListByResourceGroup(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/" + PrivateEndpointUtil.get_configured_namespace() + "/consortiumViews",
                **self.url_parameters
            )
